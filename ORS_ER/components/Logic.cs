...
namespace ORS_ER.components
{
    class Logic : Component
    {
        ...
        public override void Paint(SKCanvas canvas)
        {
            ...
            var textWidth = font.MeasureText(this.operation, Paints.TextPaint);
            float textX = buttonRect.MidX - (font.MeasureText(this.operation) / 2);
            float textY = buttonRect.MidY + font.Size / 4;
            canvas.DrawText(this.operation, textX, textY, font, Paints.TextPaint);
        }
